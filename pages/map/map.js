...
Page({
  data: {
    ...
    latitude: '',
    longitude: '',
    placeData: {title:'点击图上marker获得附近详细信息'},
    searchMethod: '酒店',
    bitmap: '',
    fail: '',
    success: '',
  ...
  onLoad: function () {
    ...
    var BMap = new bmap.BMapWX({
      ak: 'tOKYswe7Nux8xGPuC1vzbWQxYx8cdKc1'
    });
    that.setData({
      bitmap: BMap
    });
  ...
  clickHotel: function () {
    this.setData({
      searchMethod: '酒店',
      selsectState: [1, 0, 0],
      placeData: { title: '点击图上marker获得附近-酒店-详细信息' }
    });
    this.onShow();
  },
  //点击美食图标
  clickFood: function () {
    this.setData({
      searchMethod: '美食',
      selsectState: [0, 1, 0],
      placeData: { title: '点击图上marker获得附近-美食-详细信息' }
    });
    this.onShow();
  },
  //点击服务图标
  clickService: function () {
    this.setData({
      searchMethod: '生活服务',
      selsectState: [0, 0, 1],
      placeData: { title: '点击图上marker获得附近-生活服务-详细信息' }
    });
    this.onShow();
  },
  //根据不同类型，请求百度POI的数据
